#ifndef ___DateClassMember
#define ___DateClassMember
...
/**
* DateClass型のオブジェクトに空白を加えた文字列を返却する
...
string DateClass::getString() const
{
	...
	//DateClass型のオブジェクトに空白を加えた文字列を文字列ストリームに挿入
	inputString << userYear << " " << userMonth << " " << userDay << " ";
