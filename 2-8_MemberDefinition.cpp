...
//unsigned long型のビット数
const int LONGBIT = std::numeric_limits<unsigned long>::digits;
...
* @since  7.13
*/
BitSet::BitSet(int inputLower, int inputUpper) : lowerLimit(inputLower), upperLimit(inputUpper)
{
...
* @since  7.13
*/
BitSet::BitSet(const int intArray[], int elementNumber, int inputLower, int inputUpper) : lowerLimit(inputLower), upperLimit(inputUpper)
{
	//下限値から上限値までの整数を格納するために必要なunsigned long型配列の要素数を割り出す
	arraySize = (upperLimit - lowerLimit + 1) / LONGBIT + 1;
...
* @since  7.13
*/
BitSet::BitSet(const BitSet& inputSet)
{
	//配列の要素数をコピー
...
* @since 9.5
*/
unsigned long* BitSet::getBitPointer() const { return bitPointer; }
...
* @since 9.5
*/
int BitSet::getArraySize() const { return arraySize; }
...
* @since 9.5
*/
int BitSet::getLowerLimit() const { return lowerLimit; }
...
* @since 9.5
*/
int BitSet::getUpperLimit() const { return upperLimit; }
...
* @since  7.13
*/
bool BitSet::checkValid(int inputElement) const
{
	//引数の妥当性
...
* @since  7.13
*/
unsigned long BitSet::setElement(int inputElement) const
{
	//返却する値
...
* @since  7.13
*/
int BitSet::getArrayIndex(int inputElement) const
{
	//添字
	int arrayIndex;
